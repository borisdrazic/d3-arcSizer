function ArcSizer(svgSelector, id, leftAngleChanged, rightAngleChanged) {
	"use strict";
    
    var that = this;
    that.id = id;
    that.leftAngleChanged = leftAngleChanged; // Callled when drag ended for left angle. Returns id and left angle size in radians.
    that.rightAngleChanged = rightAngleChanged; // Callled when drag ended for right angle. Returns id and right angle size in radians.
    that.innerRadius = 150; // inner radius of the arc
    that.outerRadius = 190; // outer radius of the arc
    that.smallRadius = 70; // outer radius of small arc
...
var a = new ArcSizer("svg#one", 1, f, f);
var b = new ArcSizer("svg#two", 2, f, f);